    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
        ...
        <p className="text-sm text-slate-500">
          This permanently deletes all your trades, alerts, notes, and your login. There is no undo.
        </p>
        <div>
  ...
  return (
    <div className="max-w-2xl mx-auto px-8 py-10 space-y-10">
      <div className="space-y-1">
        <p className="text-[10.5px] font-bold text-slate-400 uppercase tracking-[0.07em]">Workspace controls</p>
      ...
      <SettingsSection title="Profile">
        <div className="bg-white border border-brand-subtle rounded-xl divide-y divide-brand-subtle px-4">
          <SettingsRow label="Username" description="Used in AI context and shown in the sidebar.">
      ...
      <SettingsSection title="Notifications">
        <div className="bg-white border border-brand-subtle rounded-xl divide-y divide-brand-subtle">
          <div className="px-4">
            <SettingsRow label="Alert notifications" description="Desktop notification when a price alert triggers.">
              <Toggle checked={alertNotifications} onChange={setAlertNotifications} />
            </SettingsRow>
          </div>
          <div className="px-4">
            <SettingsRow label="Market open reminder" description="Remind me when US markets open at 9:30 AM ET.">
      ...
      <SettingsSection title="System">
        ...
        {maintenanceMode && (
          <div className="bg-red-50 border border-red-200 rounded-lg px-3 py-2">
            <p className="text-xs text-red-600 font-medium">Maintenance mode active — all workers are halted.</p>
          </div>
        )}
      </SettingsSection>
      ...
      <SettingsSection title="Data">
        <div className="bg-white border border-brand-subtle rounded-xl divide-y divide-brand-subtle">
          <div className="px-4">
            <SettingsRow label="Export data" description="Download all your trades, alerts, notes, and journal as JSON.">
              <button
          ...
          <div className="px-4">
            <SettingsRow label="Delete account" description="Permanently delete your account and all data. Cannot be undone.">
              <button
